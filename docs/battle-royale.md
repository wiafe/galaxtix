...
There are no eliminations during a round. Standings at the buzzer determine qualifiers. Ties use largest single capture, fewest failed excursions, then a random order assigned at the start of the round. Harden stops movement at its border; activating it around an intruder displaces the cutter without destroying the excursion or its anchor.
