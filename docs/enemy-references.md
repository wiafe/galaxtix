...
| Brood Carrier | Roams slowly, warns for 0.9 seconds, then drops an egg. Eggs hatch after six seconds into broods that roam near the carrier, then warn and lunge at nearby exposed ships. Capture an egg for 0.25 base salvage before it hatches. Each carrier allows at most four eggs plus living mites; subsequent drops are four seconds of roaming apart. | Mokoko X's egg-spawning enemies, adapted into capturable targets. |

Roguelite broods from carriers, stationary nests, and boss hatcheries share the same hunting behavior and visuals. They notice exposed ships within 200 pixels and unobstructed sight. They stop for a 0.45-second yellow contracting-ring warning, burst for 0.65 seconds at 1.7 times normal mite speed, then recover for 0.55 seconds before warning again. Bursts turn at most 0.65 radians per second, allowing sharp dodges. Idle broods are purple and move at 45% normal mite speed. Reaching safety, blocking sight, or moving beyond 300 pixels breaks pursuit; after a 0.7-second pause they roam again. Claimed land, hardened cells and rocks block movement, including thin strips during bursts. A disconnected brood stays in its pocket, and enclosing it destroys it and frees its carrier population slot. Broods target the ship, not a chosen trail segment; crossing a trail still uses the existing contact and shield rules. Stationary nests retain their spawn timings and allow at most two living broods each. Their spawn warning stops while both slots are occupied. Capturing a nest still removes its offspring. Jump mode retains its original mite chase.
